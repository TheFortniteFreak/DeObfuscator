...
vfix = qw.QCheckBox("Fix Variable Names", )
vfix.setStyleSheet("""
		QCheckBox{
			background-color: rgba(255, 255, 255, 0);
			color: rgb(255,255,255);
...
rdead = qw.QCheckBox("Remove Dead Code", )
rdead.setStyleSheet("""
		QCheckBox{
			background-color: rgba(255, 255, 255, 0);
			color: rgb(255,255,255);
...
rdead.setChecked(True)
rdead.setSizePolicy(qw.QSizePolicy.Expanding, qw.QSizePolicy.Preferred)
rdead.setMinimumSize(80, 30)
layoutcontainer5.addWidget(rdead, 0)

rcom = qw.QCheckBox("Remove Comments", )
rcom.setStyleSheet("""
		QCheckBox{
			background-color: rgba(255, 255, 255, 0);
			color: rgb(255,255,255);
...
rcom.setSizePolicy(qw.QSizePolicy.Expanding, qw.QSizePolicy.Preferred)
rcom.setMinimumSize(80, 30)
layoutcontainer5.addWidget(rcom, 0)
